...
// ✅ Lazy-load image component for bundle efficiency
        ...
        <main className="flex-grow">
          ...
          {news?.length > 0 && (
            <section className="w-full py-10 px-4">
              ...
              >
                <Suspense fallback={<div className="text-center">Cargando imágenes...</div>}>
                      ...
                      >
                        <Link to={`/noticias/slug/${article.slug}`}>
                          <div className="relative w-full h-full">
                            <LazyImage
                              src={article.imageUrls?.[0] || "https://via.placeholder.com/600x400"}
                              alt={article.title}
                              aspectRatio="16/9"
