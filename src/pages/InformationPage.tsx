...
const InformationPage: React.FC<InformationPageProps> = ({ pageId: propPageId }) => {
  ...
  const activePageId = propPageId || paramPageId || 'informacion';

  // ✅ Added useMemo to avoid unnecessary lookups
  // Reason: Prevent recalculating `currentPage` on every render unless `activePageId` changes.
